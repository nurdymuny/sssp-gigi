...
import pandas as pd
import numpy as np
R=Path(__file__).resolve().parent; O=R/'results/revision'; F=R.parent/'figs_v3'; F.mkdir(exist_ok=True)
...
(R.parent/'benchmark_v3.html').write_text(report,encoding='utf-8')
